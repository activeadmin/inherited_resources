...
InheritedResources master is Rails 3 compatible and not backwards compatible.
A gem was not release yet, but you can use in Rails 3 by checking out the git
repository. Installing it as plugin is not supported.

If you want to use the Rails 2.3.x version, you can install the gem:
